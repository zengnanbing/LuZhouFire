...
public class BNDemoGuideActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MainFragment1.activityList.add(this);
//		createHandler();
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(MainFragment1.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
//		if (hd != null) {
...
//		}
	...
	protected void onDestroy() {
		...
		MainFragment1.activityList.remove(this);
